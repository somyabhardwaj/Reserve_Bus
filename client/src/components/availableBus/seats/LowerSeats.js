...
import { addLowerSeats } from "../../../redux/reducers/bookingDetailsSlice";

function LowerSeats({ bookedSeats }) {
    ...
    useEffect(() => {
        const selectedSeatsWithUA = selectedSeats.map(seat => `${seat}LA`);
        dispatch(addLowerSeats(selectedSeatsWithUA));
